...
<html lang = "en">
   ...
   <div class="box">
    <div class="container" style="background-color: lightbrown; padding: 22px; ">
       ...
       <table>
        ...
        <h4 style="color: white; padding: 20px;" id="login_message"> <center> </h4 style="color: white;">
        <div class="input-field">
          <center>
             <button class = "btn btn-lg btn-primary btn-block" type = "submit" name = "login">Login</button></center>
        </div>
    </form>
</table>
