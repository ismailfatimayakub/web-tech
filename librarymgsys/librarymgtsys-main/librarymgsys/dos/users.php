...
<a href="users.php" style="cursor: pointer; color: black; background-color: white !important;" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    </i>Users</a> 
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4" style="border-bottom: 2px solid #bbf1e1; background-color: #3a6605 !important; color: white !important;">
                <div class="d-flex align-items-center">
                    ...
                    <h6 style="font-size: 16px!important;" class="fs-2 m-0">Library Users</h6>
                </div>
...
if (isset($_POST['add_user'])) {
   ...
   $name = $_POST['name'];
    ...
    $zam = "INSERT INTO `lib_users`(`name`, `title`) VALUES ('$name','$title')";
    

    $tt = "SELECT * FROM lib_users WHERE name='$name'";
     $ret = mysqli_query($gift,$tt);
  if (mysqli_num_rows($ret) >= 1) {
     ?> <script type="text/javascript">alert("The user already exists, try again or change the name");</script> <?php
  }else{
    $kiza = mysqli_query($gift,$zam);
    if ($kiza) {
    ?><script type="text/javascript">alert("The user has been added");</script> <?php
...
?>
  ...
  ADD NEW
                 ...
                 ?><h6 class="fs-2"></h6>
 <p class="fs-5" style="font-size: 11px !important; font-weight: bold;">Total users
                            </div>
...
<th>Action</th>
 ...
 $get = "SELECT * from lib_users order by id desc";
$res = mysqli_query($gift,$get);
            ...
            <tr>
                ...
                <td style="font-weight: bold;"><?php echo "<a style='color: black;' class='' href='del_user.php?petty_id={$info['id']}'>delete";?></td>
...
<div id="conten" style="">
     ...
     <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="add_user" class="btn btn-success">Add</button></form>
      </div>
