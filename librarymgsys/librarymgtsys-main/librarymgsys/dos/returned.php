...
<a href="returned.php" style="cursor: pointer; color: black; background-color: white !important;" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    </i>Returned</a> 
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4" style="border-bottom: 2px solid #bbf1e1; background-color: #3a6605 !important; color: white !important;">
                <div class="d-flex align-items-center">
                    ...
                    <h6 style="font-size: 16px!important;" class="fs-2 m-0">Returned</h6>
                </div>
...
<th>Action</th>
 ...
 $get = "SELECT * from taken where status='returned' order by id desc";
