...
<th>Action</th>
 ...
 $get = "SELECT * from taken order by id desc";
$res = mysqli_query($gift,$get);
        
            while ($info=$res->fetch_assoc()) {
               ?>
            <tr>
                <td><?php echo "<a style='color: black;' class='' href='change.php?petty_id={$info['id']}'>{$info['date']}"; ?></td>
                 <td><?php echo "<a style='color: black;' class='' href='change.php?petty_id={$info['id']}'>{$info['time']}"; ?></td>
                <td><?php echo "<a style='color: black;' class='' href='change.php?petty_id={$info['id']}'>{$info['book']}"; ?></td>
