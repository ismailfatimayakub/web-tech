...
<a href="books.php" style="cursor: pointer; color: black; background-color: white !important;" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                 Books</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4" style="border-bottom: 2px solid #bbf1e1; background-color: #3a6605 !important; color: white !important;">
                <div class="d-flex align-items-center">
                    ...
                    <h6 style="font-size: 16px!important;" class="fs-2 m-0">Books</h6>
                </div>
...
if (isset($_POST['add_book'])) {
   ...
   $book_name = $_POST['book_name'];
    ...
    $zam = "INSERT INTO `books`(`book_name`, `qty`, `old_new`) VALUES ('$book_name','$quantity','$old_new')";
    

    $tt = "SELECT * FROM books WHERE book_name='$book_name'";
     $ret = mysqli_query($gift,$tt);
  if (mysqli_num_rows($ret) >= 1) {
     ?> <script type="text/javascript">alert("The book already exists, try again or change the name");</script> <?php
  }else{
    $kiza = mysqli_query($gift,$zam);
    if ($kiza) {
    ?><script type="text/javascript">alert("The book has been added");</script> <?php
...
?>
  ...
  ADD NEW
                 ...
                 ?><h6 class="fs-2"></h6>
 <p class="fs-5" style="font-size: 11px !important; font-weight: bold;">NEW BOOKS
                            </div>
    ...
    <div class="col-md-4" style="">
                 ...
                 ?><h3 class="fs-2"></h3>
  <p class="fs-5" style="font-size: 11px !important; font-weight: bold;">OLD BOOKS
                            </div>
                 ...
                 ?> <h3 class="fs-2"></h3>
<p class="fs-5" style="font-size: 11px !important; font-weight: bold;">TOTAL 
                            </div>
...
<th>Action</th>
 ...
 $get = "SELECT * from books order by id desc";
$res = mysqli_query($gift,$get);
            ...
            <tr>
                ...
                <td><?php echo "{$info['old_new']}"; ?></td>
               
                <td style="font-weight: bold;"><?php echo "<a style='color: black;' class='' href='del_book.php?petty_id={$info['id']}'>delete";?></td>
...
<div id="conten" style="">
     ...
     <div class="form-group">
       ...
       <input type="text" name="book_name" class="form-control" id="" placeholder="">
</div>
          <div class="form-group">
            <div class="row">
                <div class="col-md-12">
                   ...
                   <input type="number" onclick="validateInput();" name="quantity" class="form-control" placeholder="Enter a value">


</div>
        <div class="form-group">
            <label>Old/new</label>
      <select name="old_new" id="" required>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="add_book" class="btn btn-success">Add</button></form>
      </div>
